...
PARAMETERS: List[ParamDef] = [
    ParamDef(0x1000, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "ADC_STEPS", "", 4096),
    ParamDef(0x1001, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "ADC_SUPPLY", "mV", 5000.0),
    ParamDef(0x1100, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "CUR_OFFS_U", "", 1361),
    ParamDef(0x1101, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "CUR_OFFS_V", "", 1366),
    ParamDef(0x1102, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "CUR_SENSE_FAC", "A/", 0.01),
    ParamDef(0x1200, TYPE_UINT32, ACCESS_WRITE_AFTER_RESTART, "PWM_FREQ", "Hz", 20000),
    ParamDef(0x1300, TYPE_UINT8, ACCESS_WRITE_AFTER_RESTART, "MOTOR_POLES", "", 7),
    ParamDef(0x1301, TYPE_FLOAT32, ACCESS_WRITE_LIVE, "SPEED_REF", "Hz", 3.0),
    ParamDef(0x1302, TYPE_FLOAT32, ACCESS_WRITE_LIVE, "VOLT_REF", "V", 5.0),
    ParamDef(0x1303, TYPE_UINT64, ACCESS_WRITE_AFTER_RESTART, "CALIB_TICKS", "", 500000000),
    ParamDef(0x1304, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "RES_OFFSET", "deg", 0.0),
    ParamDef(0x1305, TYPE_FLOAT32, ACCESS_WRITE_LIVE, "ID_REF", "A", 0.0),
    ParamDef(0x1306, TYPE_FLOAT32, ACCESS_WRITE_LIVE, "IQ_REF", "A", 4.0),
    ParamDef(0x1400, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "ID_PI_KP", "", 0.05),
    ParamDef(0x1401, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "ID_PI_KI", "", 0.05),
    ParamDef(0x1402, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "ID_PI_MAX", "V", 0.5),
    ParamDef(0x1403, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "ID_PI_MIN", "V", -0.5),
    ParamDef(0x1500, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "IQ_PI_KP", "", 0.05),
    ParamDef(0x1501, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "IQ_PI_KI", "", 0.05),
    ParamDef(0x1502, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "IQ_PI_MAX", "V", 0.5),
    ParamDef(0x1503, TYPE_FLOAT32, ACCESS_WRITE_AFTER_RESTART, "IQ_PI_MIN", "V", -0.5),
    ParamDef(0x1600, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "RES_SIN_MAX", "", 4095),
    ParamDef(0x1601, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "RES_SIN_MIN", "", 0),
    ParamDef(0x1602, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "RES_COS_MAX", "", 4095),
    ParamDef(0x1603, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "RES_COS_MIN", "", 0),
    ParamDef(0x1604, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "RES_OFF_SIN", "", 2050),
    ParamDef(0x1605, TYPE_UINT16, ACCESS_WRITE_AFTER_RESTART, "RES_OFF_COS", "", 2050),
    ParamDef(0x1606, TYPE_UINT8, ACCESS_WRITE_AFTER_RESTART, "RES_POLES", "", 4),
    ParamDef(0x2000, TYPE_FLOAT32, ACCESS_READ_ONLY, "ELEC_ANGLE", "deg", 0.0),
    ParamDef(0x2001, TYPE_UINT8, ACCESS_READ_ONLY, "IS_CALIB", "", 1),
    ParamDef(0x2100, TYPE_FLOAT32, ACCESS_READ_ONLY, "I_ALPHA", "A", 0.0),
    ParamDef(0x2101, TYPE_FLOAT32, ACCESS_READ_ONLY, "I_BETA", "A", 0.0),
    ParamDef(0x2102, TYPE_FLOAT32, ACCESS_READ_ONLY, "V_ALPHA", "V", 0.0),
    ParamDef(0x2103, TYPE_FLOAT32, ACCESS_READ_ONLY, "V_BETA", "V", 0.0),
    ParamDef(0x2104, TYPE_FLOAT32, ACCESS_READ_ONLY, "I_D", "A", 0.0),
    ParamDef(0x2105, TYPE_FLOAT32, ACCESS_READ_ONLY, "I_Q", "A", 0.0),
    ParamDef(0x2106, TYPE_FLOAT32, ACCESS_READ_ONLY, "V_D", "V", 0.0),
    ParamDef(0x2107, TYPE_FLOAT32, ACCESS_READ_ONLY, "V_Q", "V", 0.0),
    ParamDef(0x2200, TYPE_FLOAT32, ACCESS_READ_ONLY, "DUTY_U", "%", 50.0),
    ParamDef(0x2201, TYPE_FLOAT32, ACCESS_READ_ONLY, "DUTY_V", "%", 50.0),
    ParamDef(0x2202, TYPE_FLOAT32, ACCESS_READ_ONLY, "DUTY_W", "%", 50.0),
    ParamDef(0x2300, TYPE_FLOAT32, ACCESS_READ_ONLY, "ID_INTGL", "", 0.0),
    ParamDef(0x2301, TYPE_FLOAT32, ACCESS_READ_ONLY, "IQ_INTGL", "", 0.0),
    ParamDef(0x2400, TYPE_FLOAT32, ACCESS_READ_ONLY, "PREV_ANGLE", "deg", 0.0),
    ParamDef(0x2401, TYPE_INT8, ACCESS_READ_ONLY, "SECTOR", "", 0),
]
...
class InverterSimulator:
    ...
    def _handle_dictionary(self, conn: socket.socket, payload: bytes) -> None:
        ...
        for p in PARAMETERS:
            ...
            record = struct.pack("<HB", p.address, ctrl)
